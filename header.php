...
<style type="text/css" media="all">
 /* CSS inserted by theme options */
	...
	h1,h2,h3, a, a:link, a:active, a:hover, .sf-menu li:hover, .sf-menu li.sfHover, .sf-menu a:focus, .sf-menu a:hover, .sf-menu a:active, #links, #links h1, #links h2, #links a:hover, div.prevnext a:hover {
